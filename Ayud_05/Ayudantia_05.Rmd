...
library(googleway)
library(data.table)
library(nominatim) ### al igual que google ways también busca información solo que de otra base de datos, me traerá latitudes y longitudes, de por ejemplo farmacias ahumada.
library(tidyverse)
library(leaflet)
library(REAT)
library(chilemapas)
...
```{r nominatim}
Restaurantes_ñuñoa <- osm_search("Restaurants in Ñuñoa, Santiago, Chile", limit=200, key = "f10irzMEGOUdbwGs5ulDVnM093EAk4EV")
